...
// CExpSetup2 wrapper class

class CExpSetup2 : public COleDispatchDriver
{
public:
	CExpSetup2(){} // Calls COleDispatchDriver default constructor
	CExpSetup2(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExpSetup2(const CExpSetup2& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
