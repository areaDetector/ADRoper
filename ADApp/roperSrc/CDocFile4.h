...
// CDocFile4 wrapper class

class CDocFile4 : public COleDispatchDriver
{
public:
	CDocFile4(){} // Calls COleDispatchDriver default constructor
	CDocFile4(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDocFile4(const CDocFile4& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
