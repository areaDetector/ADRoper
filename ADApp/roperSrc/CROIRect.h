...
// CROIRect wrapper class

class CROIRect : public COleDispatchDriver
{
public:
	CROIRect(){} // Calls COleDispatchDriver default constructor
	CROIRect(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CROIRect(const CROIRect& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
